...
import 'package:landryproject/presentation/internetConnectivity/InternetConnectivity.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<GetXNetworkManager>(
        builder: (builder)=>(_networkManager.connectionType == 0 )? InternetConnectivity() :Container(
